...
## Core Features
*   :star: User shouldn't need to use a bot command. The bot should automatically figure out if the question is just an FAQ that's worded differently.<br>
...
<br>
<img src='./images/feature1-image.png' alt="feature1-image" width="40%"><br>
...
<br>
<img src='./images/feature2-image1.png' alt="feature2-image1" width="40%">
<img src='./images/feature2-image2.png' alt="feature2-image2" width="40%"><br>
...
<img src='./images/permissions-1.png' alt="permissions-1" width="40%">
<img src='./images/permissions-2.png' alt="permissions-2" width="40%"><br>
