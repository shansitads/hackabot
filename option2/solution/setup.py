...
# faq file setup
with open('./option2/solution/data/hackathon_FAQ.csv') as faq_file:
...
with open('./option2/solution/data/judging_schedule.json') as json_file:
    judging_schedule = json.load(json_file)

# teams list file setup
with open('./option2/solution/data/teams_list.csv') as teams_file:
